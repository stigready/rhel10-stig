...
StigForge-exported Ansible role **`rhel10_stig`** · release **`0.3.0`**.
...
```bash
ansible-galaxy role install stigready.rhel10_stig,0.3.0
```
...
|---|---:|---:|---|---|---|
| `stig` | **94.29%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T123629Z |
